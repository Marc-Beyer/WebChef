...
<div id="newMeal">
    ...
    <canvas id="resizeCanvas" width="200" height="100" hidden=""></canvas> 
    <input type="file" id="file" name="fileOrg"><br>
    <p id="mealImgInputErr" class="error" hidden="">Es ist ein fehler aufgetreten!</p>
    ...
    <input type="number" step="1" value="1" min="1" id="ingredientsNr" name="ingredientsNr" required="required">
    <div id="ingredientsContainer">
        <div id="ingredients_0">
            <input type="number" step="0.001" id="ingredientQuantity_0" name="ingredientQuantity_0" class="noSpace" required="required">
            <select type="number" id="ingredientUnit_0" name="ingredientUnit_0" class="noSpace" required="required">
            ...
            <input type="text" id="ingredientName_0" name="ingredientName_0" class="noSpace" required="required">
        </div>
    </div>
    ...
    <p id="error" class="error" hidden="">Fehler!</p>
